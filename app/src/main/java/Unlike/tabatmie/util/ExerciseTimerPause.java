 ...
 */
public abstract class ExerciseTimerPause {
     ...
     */
    public ExerciseTimerPause(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     */
    public synchronized final ExerciseTimerPause create() {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (ExerciseTimerPause.this) {
